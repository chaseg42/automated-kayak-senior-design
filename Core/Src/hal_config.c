...
//extern int USER_BUTTON_Pin;
//extern int USER_BUTTON_GPIO_Port;
//extern int LED_RED_Pin;
//extern int LED_RED_GPIO_Port;
//extern int LED_GREEN_Pin;
//extern int LED_GREEN_GPIO_Port;
//extern int LED_BLUE_Pin;
//extern int LED_BLUE_GPIO_Port;
